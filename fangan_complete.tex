...
\begin{reportframe}[breakable=false]
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[height=4.5cm, keepaspectratio]{images/315mHz四路.png}\\[0.2em]
        \captionof{figure}{315\,mHz 四路}
    \end{minipage}%
    \hfill
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[height=4.5cm, keepaspectratio]{images/520霍尔编码器直流减速机.png}\\[0.2em]
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[height=4.5cm, keepaspectratio]{images/蜂鸣器1-8s二合一电量显示器.png}\\[0.2em]
        \captionof{figure}{蜂鸣器 1-8s 二合一电量显示器}
    \end{minipage}%
    \hfill
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[height=4.5cm, keepaspectratio]{images/格式电池.png}\\[0.2em]
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[height=4.5cm, keepaspectratio]{images/六轴机械臂抓手.png}\\[0.2em]
        \captionof{figure}{六轴机械臂抓手}
    \end{minipage}%
    \hfill
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[height=4.5cm, keepaspectratio]{images/数字舵机.png}\\[0.2em]
