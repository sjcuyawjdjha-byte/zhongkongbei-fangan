...
\begin{reportframe}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[height=4.2cm, keepaspectratio]{images/315mHz四路.png}
        \vspace{0.3em}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[height=4.2cm, keepaspectratio]{images/520霍尔编码器直流减速机.png}
        \vspace{0.3em}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[height=4.2cm, keepaspectratio]{images/蜂鸣器1-8s二合一电量显示器.png}
        \vspace{0.3em}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[height=4.2cm, keepaspectratio]{images/格式电池.png}
        \vspace{0.3em}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[height=4.2cm, keepaspectratio]{images/六轴机械臂抓手.png}
        \vspace{0.3em}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[height=4.2cm, keepaspectratio]{images/数字舵机.png}
        \vspace{0.3em}
...
\begin{reportframe_notitle}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[height=4.2cm, keepaspectratio]{images/直流减速电机GMR霍尔编码器.png}
        \vspace{0.3em}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[height=4.2cm, keepaspectratio]{images/AT8236双路驱动模块带稳压板.png}
        \vspace{0.3em}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[height=4.2cm, keepaspectratio]{images/K230视觉模块.png}
        \vspace{0.3em}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[height=4.2cm, keepaspectratio]{images/STM32H743ZIT6核心板.png}
        \vspace{0.3em}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[height=4.2cm, keepaspectratio]{images/STM32H750VBT6开发板.png}
        \vspace{0.3em}
